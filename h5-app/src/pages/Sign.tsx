  ...
  return (
    <div className="flex-1 flex flex-col bg-gray-50 min-h-screen">
      <div className="bg-white sticky top-0 z-20 flex items-center px-4 py-3 border-b border-gray-100">
        ...
        <span className="ml-3 text-sm font-medium text-slate-700">签到日历</span>
      </div>
      <div className="flex-1 flex flex-col items-center justify-center px-6">
        <CalendarDays size={56} className="text-indigo-200 mb-4" />
        <h2 className="text-lg font-bold text-slate-700 mb-2">签到日历</h2>
