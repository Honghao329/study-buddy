const ExportPage = {
      ...
      <el-row :gutter="20">
        <el-col :span="8">
          <el-card shadow="hover" style="border-radius:12px;text-align:center;padding:20px 0">
            ...
            <h3>用户数据</h3>
            <p style="color:#999;font-size:13px;margin-bottom:16px">导出所有用户的基本信息</p>
        ...
        <el-col :span="8">
          <el-card shadow="hover" style="border-radius:12px;text-align:center;padding:20px 0">
            ...
            <h3>笔记数据</h3>
            <p style="color:#999;font-size:13px;margin-bottom:16px">导出所有笔记的概要信息</p>
        ...
        <el-col :span="8">
          <el-card shadow="hover" style="border-radius:12px;text-align:center;padding:20px 0">
            ...
            <h3>签到数据</h3>
            <p style="color:#999;font-size:13px;margin-bottom:16px">导出所有签到记录</p>
  ...
  `,
  data() { return { exporting: { users: false, notes: false, signs: false } }; },
  methods: {
